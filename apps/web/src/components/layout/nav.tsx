  ...
  return (
    <header className="sticky top-0 z-40 safe-t">
      <div className={cn("section", isMap ? "mt-2 sm:mt-3" : "mt-3")}>
        ...
        >
          <Link href="/" className="flex items-center gap-2 px-2 py-1 shrink-0" aria-label="V-Lake home">
          ...
          <div className="ml-auto flex items-center gap-1.5 sm:gap-2">
            ...
            <button
              type="button"
              className="h-9 w-9 sm:h-10 sm:w-10 rounded-full bg-white/70 backdrop-blur border border-white/60 flex items-center justify-center text-water-800 hover:bg-white transition opacity-60 cursor-not-allowed"
