...
import { StatValue } from "./live-stats-value";
...
export async function LiveStats() {
  ...
  const cards = [
    { icon: Droplet, label: "Lakes tracked", value: (totalLakes ?? 0).toLocaleString(), tint: "from-water-400 to-water-600", temp: null },
    { icon: Globe2, label: "Countries", value: uniqueCountries.toString(), tint: "from-cyan-400 to-water-500", temp: null },
    { icon: Flame, label: "Warmest now", value: null, tint: "from-amber-400 to-red-500", temp: maxC },
    { icon: Snowflake, label: "Coldest now", value: null, tint: "from-sky-400 to-indigo-600", temp: minC },
  ];
